...
INSERT INTO "recipe"("title", "description", "difficulty", "budget", "servings", "preparation_time", "cook_time", "story", "picture", "user_id") VALUES
    ...
    ('Boeuf Bourguignon', 'Un ragoût de boeuf mijoté dans du vin rouge avec des légumes.', 'Difficile', 'Raisonnable', 6, 30, 120, 'Un plat traditionnel français réconfortant.', 'https://example.com/boeuf-bourguignon.jpg', 2),
